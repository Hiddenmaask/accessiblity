<template>
  <HelloWorld class="comp" v-if="show == 1"/>
  <CardList class="comp"  v-if="show == 2"/>
  <ImageBubble class="comp" v-if="show == 3"/>
  <div class="nav">
    <button class="btn" value="Next" @click="backShow">Back</button>
    <button class="btn" value="Next" @click="nextShow">Next</button>
  </div>
</template>
